...
class MaximumElementOccuranceValidatorTest
{
	...
	{
		// given
		Validator validator = new MaximumElementOccuranceValidator( "/some/path/to/element", 5, 6 );
		// when
	...
	{
		// given
		Validator validator = new MaximumElementOccuranceValidator( "/some/path/to/element", 7, 6 );
		// when
		Optional<ConstraintViolation> constraintViolation = validator.validate();
		// then
